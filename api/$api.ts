...
import type { Methods as Methods10 } from './api/v1/client/offices/area'
import type { Methods as Methods11 } from './api/v1/client/offices/nearest'
import type { Methods as Methods12 } from './api/v1/client/offices/search'
...
import type { Methods as Methods15 } from './api/v1/manager/appointment/_id@number'
import type { Methods as Methods16 } from './api/v1/manager/appointments'
import type { Methods as Methods17 } from './api/v1/manager/office/_id@number'
import type { Methods as Methods18 } from './api/v1/manager/office_client/_id@number'
import type { Methods as Methods19 } from './api/v1/manager/office_clients'
import type { Methods as Methods20 } from './api/v1/manager/staff/_id@number'
import type { Methods as Methods21 } from './api/v1/manager/staffs'
import type { Methods as Methods22 } from './api/v1/manager/thank/_id@number'
import type { Methods as Methods23 } from './api/v1/manager/thanks'
import type { Methods as Methods24 } from './health_check'
          ...
          appointment: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods15['patch']['status']>(prefix, prefix4, PATCH, option).send(),
                /**
                 * 予約を更新する
                 */
                $patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods15['patch']['status']>(prefix, prefix4, PATCH, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
          ...
          office: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods17['get']['status']>(prefix, prefix4, GET, option).send(),
                /**
                 * 単一の事務所の詳細を取得する
                 */
                $get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods17['get']['status']>(prefix, prefix4, GET, option).send().then(r => r.body),
                /**
                 * 単一の事務所を更新する
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
          ...
          office_client: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods18['patch']['status']>(prefix, prefix4, PATCH, option).send(),
                /**
                 * 事業所で管理している事業所利用者一覧を更新する
                 */
                $patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods18['patch']['status']>(prefix, prefix4, PATCH, option).send().then(r => r.body),
                /**
                 * 事業所で管理している事業所利用者一覧を削除する
                 */
                delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods18['delete']['status']>(prefix, prefix4, DELETE, option).send(),
                /**
                 * 事業所で管理している事業所利用者一覧を削除する
                 */
                $delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods18['delete']['status']>(prefix, prefix4, DELETE, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
          ...
          staff: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods20['delete']['status']>(prefix, prefix4, DELETE, option).send(),
                /**
                 * スタッフを削除する
                 */
                $delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods20['delete']['status']>(prefix, prefix4, DELETE, option).send().then(r => r.body),
                /**
                 * スタッフを更新する
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods20['patch']['status']>(prefix, prefix4, PATCH, option).send(),
                /**
                 * スタッフを更新する
                 */
                $patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods20['patch']['status']>(prefix, prefix4, PATCH, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
          ...
          thank: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods22['delete']['status']>(prefix, prefix4, DELETE, option).send(),
                /**
                 * お礼を削除する
                 */
                $delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods22['delete']['status']>(prefix, prefix4, DELETE, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
