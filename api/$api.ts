...
import type { Methods as Methods5 } from './api/v1/client/appointments'
import type { Methods as Methods6 } from './api/v1/client/book_mark/_id@number'
import type { Methods as Methods7 } from './api/v1/client/bookmarks'
import type { Methods as Methods8 } from './api/v1/client/histories'
import type { Methods as Methods9 } from './api/v1/client/office/_id@number'
import type { Methods as Methods10 } from './api/v1/client/offices'
import type { Methods as Methods11 } from './api/v1/client/staffs'
import type { Methods as Methods12 } from './api/v1/client/thank/_id@number'
import type { Methods as Methods13 } from './api/v1/client/thanks'
import type { Methods as Methods14 } from './api/v1/manager/appointment/_id@number'
import type { Methods as Methods15 } from './api/v1/manager/appointments'
import type { Methods as Methods16 } from './api/v1/manager/office/_id@number'
import type { Methods as Methods17 } from './api/v1/manager/office_client/_id@number'
import type { Methods as Methods18 } from './api/v1/manager/office_clients'
import type { Methods as Methods19 } from './api/v1/manager/staff/_id@number'
import type { Methods as Methods20 } from './api/v1/manager/staffs'
import type { Methods as Methods21 } from './api/v1/manager/thank/_id@number'
import type { Methods as Methods22 } from './api/v1/manager/thanks'
import type { Methods as Methods23 } from './health_check'
          ...
          office: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods9['get']['status']>(prefix, prefix4, GET, option).send(),
                /**
                 * 単一の事務所の詳細を取得する
                 */
                $get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods9['get']['status']>(prefix, prefix4, GET, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
          ...
          thank: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods12['delete']['status']>(prefix, prefix4, DELETE, option).send(),
                /**
                 * お礼を削除する
                 */
                $delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods12['delete']['status']>(prefix, prefix4, DELETE, option).send().then(r => r.body),
                /**
                 * お礼を更新する
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods12['patch']['status']>(prefix, prefix4, PATCH, option).send(),
                /**
                 * お礼を更新する
                 */
                $patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods12['patch']['status']>(prefix, prefix4, PATCH, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
          ...
          appointment: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods14['patch']['status']>(prefix, prefix4, PATCH, option).send(),
                /**
                 * 予約を更新する
                 */
                $patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods14['patch']['status']>(prefix, prefix4, PATCH, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
          ...
          office: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods16['get']['status']>(prefix, prefix4, GET, option).send(),
                /**
                 * 単一の事務所の詳細を取得する
                 */
                $get: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods16['get']['status']>(prefix, prefix4, GET, option).send().then(r => r.body),
                /**
                 * 単一の事務所を更新する
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods16['patch']['status']>(prefix, prefix4, PATCH, option).send(),
                /**
                 * 単一の事務所を更新する
                 */
                $patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods16['patch']['status']>(prefix, prefix4, PATCH, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
          office_client: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods17['patch']['status']>(prefix, prefix4, PATCH, option).send(),
                /**
                 * 事業所で管理している事業所利用者一覧を更新する
                 */
                $patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods17['patch']['status']>(prefix, prefix4, PATCH, option).send().then(r => r.body),
                /**
          ...
          staff: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods19['delete']['status']>(prefix, prefix4, DELETE, option).send(),
                /**
                 * スタッフを削除する
                 */
                $delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods19['delete']['status']>(prefix, prefix4, DELETE, option).send().then(r => r.body),
                /**
                 * スタッフを更新する
                 */
                patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods19['patch']['status']>(prefix, prefix4, PATCH, option).send(),
                /**
                 * スタッフを更新する
                 */
                $patch: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods19['patch']['status']>(prefix, prefix4, PATCH, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
          ...
          thank: {
            _id: (val4: number) => {
              ...
              return {
                 ...
                 */
                delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods21['delete']['status']>(prefix, prefix4, DELETE, option).send(),
                /**
                 * お礼を削除する
                 */
                $delete: (option?: { config?: T | undefined } | undefined) =>
                  fetch<void, BasicHeaders, Methods21['delete']['status']>(prefix, prefix4, DELETE, option).send().then(r => r.body),
                $path: () => `${prefix}${prefix4}`
              }
            }
          },
