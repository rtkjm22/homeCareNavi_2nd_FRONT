...
import type { Methods as Methods5 } from './v1/client/book_mark/_id@number'
import type { Methods as Methods6 } from './v1/client/bookmarks'
import type { Methods as Methods7 } from './v1/client/histories'
import type { Methods as Methods8 } from './v1/client/offices/_id@number'
import type { Methods as Methods9 } from './v1/client/offices/area_search'
import type { Methods as Methods10 } from './v1/client/offices/nearest_search'
import type { Methods as Methods11 } from './v1/client/offices/word_search'
import type { Methods as Methods12 } from './v1/client/reserves'
import type { Methods as Methods13 } from './v1/client/thank/_id@number'
import type { Methods as Methods14 } from './v1/client/thanks'
import type { Methods as Methods15 } from './v1/manager/office'
import type { Methods as Methods16 } from './v1/manager/office_clients'
import type { Methods as Methods17 } from './v1/manager/office_clients/_id@number'
import type { Methods as Methods18 } from './v1/manager/office_images'
import type { Methods as Methods19 } from './v1/manager/office_images/_id@number'
import type { Methods as Methods20 } from './v1/manager/office_overview'
import type { Methods as Methods21 } from './v1/manager/reserve/_id@number'
import type { Methods as Methods22 } from './v1/manager/reserves'
import type { Methods as Methods23 } from './v1/manager/staffs'
import type { Methods as Methods24 } from './v1/manager/staffs/_id@number'
import type { Methods as Methods25 } from './v1/manager/thank/_id@number'
import type { Methods as Methods26 } from './v1/manager/thanks'
...
const api = <T>({ baseURL, fetch }: AspidaClient<T>) => {
  ...
  const PATH19 = '/api/v1/manager/reserve'
  const PATH20 = '/api/v1/manager/reserves'
      ...
      manager: {
          ...
          _id: (val3: number) => {
            ...
            return {
              ...
              patch: (option: { body: Methods17['patch']['reqBody'], headers?: Methods17['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
                fetch<void, BasicHeaders, Methods17['patch']['status']>(prefix, prefix3, PATCH, option, 'FormData').send(),
              /**
               * 事業所で管理している事業所利用者を更新する
               * @param option.body - ※画像はContentTypeがapplication/jsonでは送信出来ないため、multipart/form-dataかつformDataでラップして送信すること
               */
              $patch: (option: { body: Methods17['patch']['reqBody'], headers?: Methods17['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
                fetch<void, BasicHeaders, Methods17['patch']['status']>(prefix, prefix3, PATCH, option, 'FormData').send().then(r => r.body),
              /**
          ...
          _id: (val3: number) => {
            ...
            return {
              ...
              patch: (option: { body: Methods19['patch']['reqBody'], headers?: Methods19['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
                fetch<Methods19['patch']['resBody'], BasicHeaders, Methods19['patch']['status']>(prefix, prefix3, PATCH, option, 'FormData').json(),
              /**
               * Manager自身の事業所画像を更新する
               * @param option.body - ※画像はContentTypeがapplication/jsonでは送信出来ないため、multipart/form-dataかつformDataでラップして送信すること
               * @returns OK
               */
              $patch: (option: { body: Methods19['patch']['reqBody'], headers?: Methods19['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
                fetch<Methods19['patch']['resBody'], BasicHeaders, Methods19['patch']['status']>(prefix, prefix3, PATCH, option, 'FormData').json().then(r => r.body),
              $path: () => `${prefix}${prefix3}`
            }
          },
          /**
          ...
          _id: (val3: number) => {
            ...
            return {
              ...
              patch: (option: { body: Methods21['patch']['reqBody'], headers?: Methods21['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
                fetch<Methods21['patch']['resBody'], BasicHeaders, Methods21['patch']['status']>(prefix, prefix3, PATCH, option).json(),
              /**
               * 予約を更新する
               * @returns OK
               */
              $patch: (option: { body: Methods21['patch']['reqBody'], headers?: Methods21['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
                fetch<Methods21['patch']['resBody'], BasicHeaders, Methods21['patch']['status']>(prefix, prefix3, PATCH, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix3}`
            }
          }
        },
        ...
        staffs: {
          _id: (val3: number) => {
            ...
            return {
              ...
              delete: (option?: { headers?: Methods24['delete']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods24['delete']['status']>(prefix, prefix3, DELETE, option).send(),
              /**
               * スタッフを削除する
               */
              $delete: (option?: { headers?: Methods24['delete']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
                fetch<void, BasicHeaders, Methods24['delete']['status']>(prefix, prefix3, DELETE, option).send().then(r => r.body),
              /**
               * スタッフを更新する
               * @returns OK
               */
              patch: (option: { body: Methods24['patch']['reqBody'], headers?: Methods24['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
                fetch<Methods24['patch']['resBody'], BasicHeaders, Methods24['patch']['status']>(prefix, prefix3, PATCH, option).json(),
              /**
               * スタッフを更新する
               * @returns OK
               */
              $patch: (option: { body: Methods24['patch']['reqBody'], headers?: Methods24['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
                fetch<Methods24['patch']['resBody'], BasicHeaders, Methods24['patch']['status']>(prefix, prefix3, PATCH, option).json().then(r => r.body),
              $path: () => `${prefix}${prefix3}`
            }
          },
          /**
          ...
          get: (option?: { headers?: Methods23['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods23['get']['resBody'], BasicHeaders, Methods23['get']['status']>(prefix, PATH21, GET, option).json(),
          /**
           * スタッフ一覧を取得する
           * @returns OK
           */
          $get: (option?: { headers?: Methods23['get']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
            fetch<Methods23['get']['resBody'], BasicHeaders, Methods23['get']['status']>(prefix, PATH21, GET, option).json().then(r => r.body),
          /**
           * スタッフを追加する
           * @returns OK
           */
          post: (option: { body: Methods23['post']['reqBody'], headers?: Methods23['post']['reqHeaders'] | undefined, config?: T | undefined }) =>
            fetch<Methods23['post']['resBody'], BasicHeaders, Methods23['post']['status']>(prefix, PATH21, POST, option).json(),
          /**
           * スタッフを追加する
           * @returns OK
           */
          $post: (option: { body: Methods23['post']['reqBody'], headers?: Methods23['post']['reqHeaders'] | undefined, config?: T | undefined }) =>
            fetch<Methods23['post']['resBody'], BasicHeaders, Methods23['post']['status']>(prefix, PATH21, POST, option).json().then(r => r.body),
          $path: () => `${prefix}${PATH21}`
        },
        thank: {
          _id: (val3: number) => {
        ...
        thanks: {
           ...
           */
          get: (option?: { config?: T | undefined } | undefined) =>
            fetch<void, BasicHeaders, Methods26['get']['status']>(prefix, PATH23, GET, option).send(),
          /**
           * お礼一覧を取得する
           */
          $get: (option?: { config?: T | undefined } | undefined) =>
            fetch<void, BasicHeaders, Methods26['get']['status']>(prefix, PATH23, GET, option).send().then(r => r.body),
          $path: () => `${prefix}${PATH23}`
        }
      }
    }
