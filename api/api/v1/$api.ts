...
import type { Methods as Methods1 } from './auth/password'
import type { Methods as Methods2 } from './auth/sign_in'
import type { Methods as Methods3 } from './auth/sign_out'
import type { Methods as Methods4 } from './auth/validate_token'
import type { Methods as Methods5 } from './client/book_mark/_id@number'
import type { Methods as Methods6 } from './client/bookmarks'
import type { Methods as Methods7 } from './client/histories'
import type { Methods as Methods8 } from './client/offices/_id@number'
import type { Methods as Methods9 } from './client/offices/area_search'
import type { Methods as Methods10 } from './client/offices/nearest_search'
import type { Methods as Methods11 } from './client/offices/word_search'
import type { Methods as Methods12 } from './client/reserves'
import type { Methods as Methods13 } from './client/thank/_id@number'
import type { Methods as Methods14 } from './client/thanks'
import type { Methods as Methods15 } from './manager/office'
import type { Methods as Methods16 } from './manager/office_clients'
import type { Methods as Methods17 } from './manager/office_clients/_id@number'
import type { Methods as Methods18 } from './manager/office_images'
import type { Methods as Methods19 } from './manager/office_images/_id@number'
import type { Methods as Methods20 } from './manager/office_overview'
import type { Methods as Methods21 } from './manager/reserve/_id@number'
import type { Methods as Methods22 } from './manager/reserves'
import type { Methods as Methods23 } from './manager/staffs'
import type { Methods as Methods24 } from './manager/staffs/_id@number'
import type { Methods as Methods25 } from './manager/thank/_id@number'
import type { Methods as Methods26 } from './manager/thanks'
        ...
        _id: (val2: number) => {
          ...
          return {
            ...
            patch: (option: { body: Methods17['patch']['reqBody'], headers?: Methods17['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods17['patch']['status']>(prefix, prefix2, PATCH, option, 'FormData').send(),
            /**
             * 事業所で管理している事業所利用者を更新する
             * @param option.body - ※画像はContentTypeがapplication/jsonでは送信出来ないため、multipart/form-dataかつformDataでラップして送信すること
             */
            $patch: (option: { body: Methods17['patch']['reqBody'], headers?: Methods17['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
              fetch<void, BasicHeaders, Methods17['patch']['status']>(prefix, prefix2, PATCH, option, 'FormData').send().then(r => r.body),
            /**
        ...
        _id: (val2: number) => {
          ...
          return {
            ...
            patch: (option: { body: Methods19['patch']['reqBody'], headers?: Methods19['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
              fetch<Methods19['patch']['resBody'], BasicHeaders, Methods19['patch']['status']>(prefix, prefix2, PATCH, option, 'FormData').json(),
            /**
             * Manager自身の事業所画像を更新する
             * @param option.body - ※画像はContentTypeがapplication/jsonでは送信出来ないため、multipart/form-dataかつformDataでラップして送信すること
             * @returns OK
             */
            $patch: (option: { body: Methods19['patch']['reqBody'], headers?: Methods19['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
              fetch<Methods19['patch']['resBody'], BasicHeaders, Methods19['patch']['status']>(prefix, prefix2, PATCH, option, 'FormData').json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        },
        /**
      ...
      staffs: {
        _id: (val2: number) => {
          ...
          return {
             ...
             */
            $delete: (option?: { headers?: Methods24['delete']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
              fetch<void, BasicHeaders, Methods24['delete']['status']>(prefix, prefix2, DELETE, option).send().then(r => r.body),
            /**
             * スタッフを更新する
             * @returns OK
             */
            patch: (option: { body: Methods24['patch']['reqBody'], headers?: Methods24['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
              fetch<Methods24['patch']['resBody'], BasicHeaders, Methods24['patch']['status']>(prefix, prefix2, PATCH, option).json(),
            /**
             * スタッフを更新する
             * @returns OK
             */
            $patch: (option: { body: Methods24['patch']['reqBody'], headers?: Methods24['patch']['reqHeaders'] | undefined, config?: T | undefined }) =>
              fetch<Methods24['patch']['resBody'], BasicHeaders, Methods24['patch']['status']>(prefix, prefix2, PATCH, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        },
        /**
