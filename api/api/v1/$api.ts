...
import type { Methods as Methods21 } from './manager/reserves'
import type { Methods as Methods22 } from './manager/reserves/_id@number'
        ...
        _id: (val2: number) => {
          ...
          return {
            ...
            patch: (option?: { headers?: Methods22['patch']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods22['patch']['resBody'], BasicHeaders, Methods22['patch']['status']>(prefix, prefix2, PATCH, option).json(),
            /**
             * 予約を更新する
             * @returns OK
             */
            $patch: (option?: { headers?: Methods22['patch']['reqHeaders'] | undefined, config?: T | undefined } | undefined) =>
              fetch<Methods22['patch']['resBody'], BasicHeaders, Methods22['patch']['status']>(prefix, prefix2, PATCH, option).json().then(r => r.body),
            $path: () => `${prefix}${prefix2}`
          }
        },
        /**
