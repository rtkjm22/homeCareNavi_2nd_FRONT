<template>
  ...
  >
    ...
    <NuxtLink :to="`/offices/${id}`" class="block p-3 w-full h-full z-10">
      ...
      <!-- お礼コメント: TODO お礼作成する余裕があれば追加 -->
      <AThanksMsg thanks-msg="ここにお礼テキストが入ります。ここにお礼テキストが入ります。ここにお礼テキストが入ります最大50文字" />
...
defineProps<ResponseSearchOffice>()
</script>
